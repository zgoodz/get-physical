...
Appointment.create(date: nil, location: "Carl Shurtz Park", level: 2, duration: 60, capacity: 20, trainer_id: 1)
Appointment.create(date: nil, location: "Central Park", level: 3, duration: 45, capacity: 50, trainer_id: 2)
